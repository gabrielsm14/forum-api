...
public class TopicosController {
	...
	@GetMapping
	@Cacheable(value = "listaDeTopicos") // essa string funciona como se fosse um Id //Para indicar ao Spring o nome do
											// cache associado a um determinado método
	...
	@PostMapping
	@Transactional
	@CacheEvict(value = "listaDeTopicos", allEntries = true) // serve para limpar, invalidar um determinado cache//
